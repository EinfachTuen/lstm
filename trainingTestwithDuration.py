...
for channel in midiEvents:
    ...
    printHistory(specialModel(midiEvents[item]["notes"],midiEvents[item]["channel"], folderName, hl_Neuronen_Duration, sequence_length, epochen, batch_size),midiEvents[item]["channel"])
    item = item + 1
